...
function OpenPage(page) {
	...
	if(!element.hasClass("mCustomScrollbar")) {
		element.append('<a href="/resume/download" target="_blank"><img src="/content/images/download.png" alt="download" class="downbtn" style="display: block; width: 24px; height: 24px; position: absolute; top: 1px; right: 26px;"></a>');
